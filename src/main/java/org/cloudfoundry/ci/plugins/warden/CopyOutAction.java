 ...
 * 
 */
public class CopyOutAction extends AbstractDescribableImpl<CopyOutAction> {
    ...
    public CopyOutAction(String srcPath, String destPath) {
    ...
    @Extension
    public static final class DescriptorImpl extends Descriptor<CopyOutAction> {
